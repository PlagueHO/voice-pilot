import { ConversationStateMachine, CopilotResponseEvent } from "../../src/conversation/conversation-state-machine";
...
} from "../../src/types/speech-to-text";
import { TtsPlaybackEvent } from "../../src/types/tts";
